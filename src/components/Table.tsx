  ...
  <tr
    ...
    className={cn(
      "border-b border-[var(--color-border)] transition-colors " +
        "hover:bg-[var(--color-muted)]/50 data-[state=selected]:bg-[var(--color-muted)]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-2 text-left align-middle text-xs font-medium uppercase tracking-wider text-[var(--color-muted-foreground)]",
      className,
    )}
    {...props}
  />
